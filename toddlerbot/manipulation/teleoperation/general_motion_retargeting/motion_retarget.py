...
class GeneralMotionRetargeting:
    ...
    def __init__(
        ...
        if tgt_robot == "stanford_toddy_vr":
        ...
        if self.is_general:
            ...
            self.ik_match_table1 = yaml_table_2_dict(ik_config["ik_match_table"])
            self.ik_match_table2 = {}
            self.human_root_name = ik_config["human_root_name"]
            self.robot_root_name = ik_config["robot_root_name"]
            self.use_ik_match_table1 = True
            self.use_ik_match_table2 = False
    ...
    def setup_retarget_configuration(self):
        ...
        for frame_name, entry in self.ik_match_table1.items():
            if len(entry) == 5:
                ...
                body_name, frame_type, pos_weight, rot_weight, pos_offset, rot_offset = entry
    ...
    def retarget_data(self):
        return mj.MjData(self.model)

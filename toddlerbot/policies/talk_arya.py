"""Arya conversational AI policy using OpenAI real-time API.

This module implements the Arya personality for natural speech interaction,
managing real-time audio processing and conversation flow with OpenAI's API.
"""
...
class TalkAryaPolicy(BasePolicy):
    client: AsyncOpenAI
